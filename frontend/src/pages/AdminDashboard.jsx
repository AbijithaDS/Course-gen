              ...
              {loadingGens ? (
                ...
                <div className="dashboard-scroll-content">
                  ...
                  <table className="responsive-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.85rem' }}>
                    <thead>
                      <tr style={{ borderBottom: '2px solid var(--border-light)', color: 'var(--text-secondary)' }}>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '26%' }}>Subject</th>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '24%' }}>Scope</th>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '20%' }}>Type</th>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '14%' }}>Generated By</th>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '10%' }}>Word Count</th>
                        <th style={{ padding: '0.65rem 0.75rem', fontWeight: 600, width: '6%', textAlign: 'center' }}>Details</th>
                      </tr>
                    </thead>
                    <tbody>
                      {filteredGenerations.map(gen => {
                        ...
                        return (
                          <tr key={gen.id} className="premium-table-row" style={{ borderBottom: '1px solid var(--border-light)' }}>
                            {/* Subject Column */}
                            <td data-label="Subject" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle' }}>
                            ...
                            {/* Scope Column */}
                            <td data-label="Scope" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle', whiteSpace: 'nowrap' }}>
                            ...
                            {/* Type Column */}
                            <td data-label="Type" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle', whiteSpace: 'nowrap' }}>
                            ...
                            {/* Generated By Column */}
                            <td data-label="Generated By" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle' }}>
                            ...
                            {/* Word Count Column */}
                            <td data-label="Word Count" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle', whiteSpace: 'nowrap', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                              {gen.wordCount} words
                            </td>
                            {/* Details Column */}
                            <td data-label="Details" style={{ padding: '0.65rem 0.75rem', verticalAlign: 'middle', textAlign: 'center', whiteSpace: 'nowrap' }}>
                              <button 
